...
export type Tab = 'perfumes' | 'aromas' | 'ocasiones' | 'categorias' | 'presentaciones' | 'gamas' | 'combos' | 'precios' | 'descuentos' | 'ventas' | 'creditos' | 'pagos' | 'usuarios' | 'publicidad' | 'recompensas' | 'resenas' | 'avisos' | 'nosotros' | 'blog' | 'redes' | 'cotizaciones' | 'formulas' | 'costos' | 'devoluciones' | 'inventario' | 'producciones' | 'reposicion' | 'rep_ventas' | 'rep_compras' | 'rep_clientes';
