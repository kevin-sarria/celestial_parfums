...
export const creditosColumns: ColumnDef<Credito>[] = [
  ...
  { key: 'total_abonado', header: 'Abonado', type: 'currency',
    getValue: c => [c.abono_1,c.abono_2,c.abono_3,c.abono_4,c.abono_5,c.abono_6,c.abono_7,c.abono_8,c.abono_9,c.abono_10].reduce((s,a) => s+(a??0), 0),
    render: c => formatPrice([c.abono_1,c.abono_2,c.abono_3,c.abono_4,c.abono_5,c.abono_6,c.abono_7,c.abono_8,c.abono_9,c.abono_10].reduce((s,a) => s+(a??0), 0)),
