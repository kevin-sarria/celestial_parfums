...
import { createPerfumeSchema, patchDescuentoSchema, patchDescuentoCategoriaSchema, asignarEsenciaMasivaSchema, patchAgotadoSchema, nombreSchema, precioListaSchema } from '../schemas/perfume.schema';
